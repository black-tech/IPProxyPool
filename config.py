...
parserList = [
    {
        'urls': ['http://www.66ip.cn/%s.html' % n for n in ['index'] + list(range(2, 120))],
        'type': 'xpath',
    ...
    {
        'urls': ['http://www.mimiip.com/gngao/%s' % n for n in range(1, 200)],
        'type': 'xpath',
...
MINNUM = 100  # 当有效的ip值小于一个时 需要启动爬虫进行爬取
